        ...
        value: function listenner() {
            ...
            Sprint(this.$goban).on('click', function (e) {
                if (_this.Gameplay.addRock(e)) {
                    ...
                    if (type == 'rush' && players.getCurrent().getName() == 2) {
                        _this.AI.play();
                        setTimeout(function () {
                            _this.update();
                        }, _this.AI.getDelay());
    ...
    _createClass(Chain, [{
        ...
        value: function getBorders() {
            ...
            this.border = (function () {
                ...
                try {
                    for (var _iterator = _this2.rocks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        value: function getLiberties() {
            ...
            try {
                for (var _iterator2 = this.getBorders(rocks)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    ...
                    try {
                        for (var _iterator3 = rocks.select(rock).getLiberties('objects')[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            ...
            if (select != 'all' && select != 'empty') {
                (function () {
                    ...
                    _this3.neighboringRocks = (function () {
                        ...
                        try {
                            for (var _iterator4 = _this3.cache[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
var GameplayActions = (function () {
    ...
    _createClass(GameplayActions, [{
        ...
        value: function checkSuicide() {
            ...
            try {
                for (var _iterator6 = this.cache[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
            ...
            if (count == 0) {
                ...
                if (this.cache.length != 0) {
                    ...
                    try {
                        for (var _iterator8 = this.cache[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
        ...
        value: function addRock(e) {
            var origin = arguments[1] === undefined ? 'human' : arguments[1];
            ...
            // If the player can play here (the test is before done if it's a robot)
            if (origin == 'robot' || this.check()) {
                ...
                // If it's a human, we upadte the historic
                if (origin == 'human') {
                    players.getCurrent().updateHistoric({
                        type: 'add-rock',
                        params: {
        ...
        value: function updateChains() {
            ...
            if (neighbors.length != 0) {
                ...
                try {
                    for (var _iterator9 = neighbors[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                ...
                // CASE 2 : Join chains
                    ...
                    try {
                        for (var _iterator10 = chainsOfNeighbors.reverse()[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
                            var _chain = _step10.value;
                            ...
                            if (_chain != joinChain) {
                                ...
                                try {
                                    for (var _iterator11 = chains.select(_chain).getRocks()[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
        ...
        value: function updateGoban() {
            ...
            if (neighbors.length != 0) {
                ...
                try {
                    for (var _iterator12 = neighbors[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
                ...
                try {
                    for (var _iterator13 = chainsOfNeighbors[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
                        var chain = _step13.value;
                        ...
                        if (chains.select(chain).getLiberties() == 0) {
                            ...
                            try {
                                for (var _iterator14 = chains.select(chain).getRocks()[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
...
var gameplayRobotActions = (function (_GameplayActions) {
    ...
    function gameplayRobotActions() {
        _classCallCheck(this, gameplayRobotActions);

        _get(Object.getPrototypeOf(gameplayRobotActions.prototype), 'constructor', this).call(this);
    }

    _inherits(gameplayRobotActions, _GameplayActions);

    _createClass(gameplayRobotActions, [{
        key: 'play',
        ...
        value: function play() {
            ...
            } while (!_get(Object.getPrototypeOf(gameplayRobotActions.prototype), 'check', this).call(this));
            ...
            setTimeout(function () {
                _get(Object.getPrototypeOf(gameplayRobotActions.prototype), 'addRock', _this4).call(_this4, rock, 'robot');
            }, this.delay);
        }
    }, {
        key: 'getDelay',
